...
CREATE TABLE public.tickets (
    ...
    red_celular text,
    patron_desbloqueo integer[] DEFAULT '{}'::integer[],
    created_at timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp(3) without time zone NOT NULL
);
...
COPY public.clientes (id, nombre, apellido_paterno, apellido_materno, telefono_celular, telefono_contacto, email, calle, numero_exterior, numero_interior, colonia, ciudad, estado, codigo_postal, latitud, longitud, fuente_referencia, rfc, password_hash, created_at, updated_at, creado_por_id, tipo_registro) FROM stdin;
1	Roberto	Gomez	Bolaños	5544332211	7711234567	chespirito@televisa.com	Bldv. Adolfo Lopez Mateos	1311		San Angel	Mexico	CDMX	01000	\N	\N		BUGA670501	\N	2025-06-13 11:29:52.621	2025-06-13 11:29:52.62	1	REGISTRO_TIENDA
\.
...
1	2	10	2000		2025-06-13 12:17:33.577	1	1	2025-06-13 12:17:33.577	2025-06-13 12:17:33.577
2	1	10	3000		2025-06-13 12:17:42.939	1	1	2025-06-13 12:17:42.939	2025-06-13 12:17:42.939
\.
...
1	PRODUCTO	Bateria para iPhone 16 Pro	Apple	iPhone 16 Pro	2000	3000	2	\N	system	system	2025-06-13 12:18:06.904	2025-06-13 12:18:06.904
2	PRODUCTO	Diagnóstico	-	-	0	100	3	\N	system	system	2025-06-13 12:19:33.754	2025-06-13 12:19:33.754
3	PRODUCTO	Mano de Obra	-	-	0	500	4	\N	system	system	2025-06-13 12:20:11.072	2025-06-13 12:20:11.072
4	PRODUCTO	Pantalla iPhone 16 Pro	Apple	iPhone 16 Pro	3000	4000	1	\N	system	system	2025-06-13 12:23:59.372	2025-06-13 12:23:59.372
\.
...
3	0003	Diagnóstico	\N	\N	0	dias	\N	\N	\N	\N	0	0	6	0	0	SERVICIO	2025-06-13 12:17:10.32	2025-06-13 12:17:10.32
4	0004	Mano de Obra	\N	\N	0	dias	\N	\N	\N	\N	0	0	6	0	0	SERVICIO	2025-06-13 12:17:20.235	2025-06-13 12:17:20.235
2	0002	Bateria para iPhone 16 Pro	\N	\N	0	dias	\N	10	53	\N	2000	10	6	0	5	PRODUCTO	2025-06-13 12:16:59.603	2025-06-13 12:17:49.867
1	0001	Pantalla iPhone 16 Pro	\N	\N	0	dias	\N	10	53	\N	3000	10	6	0	3	PRODUCTO	2025-06-13 12:16:36.23	2025-06-13 12:17:53.804
\.
...
1	Aureliano Buendía García	Aureliano Buendía García	5544332211	aureliano@100anios.com	camino a macondo s/n	\N	Bienestar	12345234598754	1232312345	BUGA670501	FISICA	2025-06-13 12:16:10.302	2025-06-13 12:16:10.302
\.
...
--
-- Name: checklist_diagnostico checklist_diagnostico_reparacion_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.checklist_diagnostico
    ADD CONSTRAINT checklist_diagnostico_reparacion_id_key UNIQUE (reparacion_id);
...
--
-- Name: estatus_reparacion estatus_reparacion_nombre_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.estatus_reparacion
    ADD CONSTRAINT estatus_reparacion_nombre_key UNIQUE (nombre);
...
--
-- Name: presupuestos presupuestos_ticket_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.presupuestos
    ADD CONSTRAINT presupuestos_ticket_id_key UNIQUE (ticket_id);
...
--
-- Name: reparaciones reparaciones_ticket_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.reparaciones
    ADD CONSTRAINT reparaciones_ticket_id_key UNIQUE (ticket_id);
...
--
-- Name: tickets tickets_direccion_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tickets
    ADD CONSTRAINT tickets_direccion_id_key UNIQUE (direccion_id);


--
-- Name: tickets tickets_imei_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tickets
    ADD CONSTRAINT tickets_imei_key UNIQUE (imei);


--
-- Name: tickets tickets_numero_ticket_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
