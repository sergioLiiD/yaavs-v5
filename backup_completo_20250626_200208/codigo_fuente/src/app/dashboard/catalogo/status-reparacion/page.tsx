  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={openModal}
          className="bg-[#FEBF19] text-gray-900 px-4 py-2 rounded-md hover:bg-[#FEBF19]/90 focus:outline-none focus:ring-2 focus:ring-[#FEBF19] focus:ring-offset-2 whitespace-nowrap"
        >
          <HiPlus className="mr-2 inline" /> Nuevo Estado
        </button>
      </div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div 
                        ...
                        style={{ backgroundColor: estado.color || '#3498db' }}
                      ></div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-center">
                    <div className="flex justify-center space-x-2">
                      ...
                      <button
                        ...
                        className={`text-gray-400 hover:text-gray-600 ${index === estadosOrdenados.length - 1 ? 'opacity-50 cursor-not-allowed' : ''}`}
                      >
                  ...
                  <div className="mb-4">
                    ...
                    <div className="mt-1 flex items-center">
                      <input
                        ...
                        name="color"
                        id="color"
                        value={currentEstado.color || '#3498db'}
                        onChange={handleInputChange}
                        className="h-10 w-20 rounded border-gray-300"
                        required
                      />
                      <span className="ml-2 text-sm text-gray-500">
                        {currentEstado.color || '#3498db'}
                      </span>
                    </div>
                  </div>
                  <div className="mb-4">
