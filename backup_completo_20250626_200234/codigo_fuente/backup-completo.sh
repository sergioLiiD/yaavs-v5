...
node --version >> "${BACKUP_DIR}/sistema/info_proyecto.txt" 2>&1 || echo "Node.js: No instalado" >> "${BACKUP_DIR}/sistema/info_proyecto.txt"
npm --version >> "${BACKUP_DIR}/sistema/info_proyecto.txt" 2>&1 || echo "npm: No instalado" >> "${BACKUP_DIR}/sistema/info_proyecto.txt"
