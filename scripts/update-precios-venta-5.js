...
// Datos de precios - Quinto bloque
...
async function updatePreciosBloque5() {
  const result = {
  ...
  try {
    console.log('🚀 Iniciando actualización de precios - Bloque 5 (FINAL)...\n');
    ...
    // Mostrar resumen
    console.log('\n📊 RESUMEN DE ACTUALIZACIÓN - BLOQUE 5 (FINAL):');
