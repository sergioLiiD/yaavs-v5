...
// Datos de precios - Primer bloque
...
async function updatePreciosBloque1() {
  const result = {
  ...
  try {
    console.log('🚀 Iniciando actualización de precios - Bloque 1...\n');
