...
// Datos de precios - Cuarto bloque desde el archivo .txt
...
async function updatePreciosVentaBloque4() {
  const result = {
  ...
  try {
    console.log('🚀 Iniciando actualización de precios de venta - Bloque 4...\n');
