...
// Datos de precios de Apple desde el archivo .txt
const PRECIOS_APPLE = [
...
async function updatePreciosVentaApple() {
  const result = {
  ...
  try {
    console.log('🚀 Iniciando actualización de precios de venta - Apple...\n');
