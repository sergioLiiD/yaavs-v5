...
async function updatePreciosBloque6() {
  const result = {
  ...
  try {
    console.log('🚀 Iniciando actualización de precios - Bloque 6 (FINAL)...\n');
    ...
    // Mostrar resumen
    console.log('\n📊 RESUMEN DE ACTUALIZACIÓN - BLOQUE 6 (FINAL):');
